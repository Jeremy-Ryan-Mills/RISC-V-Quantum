# Verify your filesets exist
get_filesets

# Set include dirs for synthesis and simulation
...
# Mark the header as a header file type
...
# Recompute compile order
update_compile_order -fileset sources_1
update_compile_order -fileset sim_1

# Clean and re-run synthesis
reset_run synth_1
